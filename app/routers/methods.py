...
def read_methods(skip: int = 0, limit: int = 100, db: Session = Depends(get_db)):
...
@methods_router.get("/params/{param_id}", response_model=schemas.MethodParam)
...
@methods_router.put("/params/{param_id}", response_model=schemas.MethodParam)
...
@methods_router.delete("/params/{param_id}", response_model=schemas.MethodParam)
